...
public class QuestionAdapter extends EasyRVAdapter<SeriacontentListEntity.SeriacontentEntity> {
    public QuestionAdapter(Context context, List<SeriacontentListEntity.SeriacontentEntity> list, int... layoutIds) {
