package com.taosx.one.Util.Glide;
...
import com.taosx.one.Util.Glide.Listener.BitmapLoadingListener;
import com.taosx.one.Util.Glide.Listener.LoaderListener;
import com.taosx.one.Util.Glide.Transformation.BlurTransformation;
import com.taosx.one.Util.Glide.Transformation.CropCircleTransformation;
import com.taosx.one.Util.Glide.Transformation.GrayscaleTransformation;
import com.taosx.one.Util.Glide.Transformation.RotateTransformation;
import com.taosx.one.Util.Glide.Transformation.RoundedCornersTransformation;
import com.taosx.one.Util.Glide.Utils.GlideConfig;
import com.taosx.one.Util.Glide.Utils.ImageLoadConfig;
import com.taosx.one.Util.Glide.Utils.SimpleGlideModule;
...
//            .setErrorResId(R.mipmap.ic_launcher)
        ...
        try {
            ...
            if (config.isAsGif()) {//gif类型
                ...
                if (config.isRoundedCorners()) {
                    request.transform(new RoundedCornersTransformation(context, 6, 6));
    ...
    public static synchronized long getDiskCacheSize(Context context) {
        long size = 0L;
        File cacheDir = PathUtils.getDiskCacheDir(context, GlideConfig.CacheFileName);
